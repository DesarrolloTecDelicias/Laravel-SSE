...
class SurveyThreeGraduate extends Component
{
    ...
    public function save()
    {
        ...
        $validateData['competence1'] = $this->workVisibility ? $validateData['competence1'] : null;
        $validateData['competence2'] = $this->workVisibility ? $validateData['competence2'] : null;
        $validateData['competence3'] = $this->workVisibility ? $validateData['competence3'] : null;
        $validateData['competence4'] = $this->workVisibility ? $validateData['competence4'] : null;
        $validateData['competence5'] = $this->workVisibility ? $validateData['competence5'] : null;
        $validateData['competence6'] = $this->workVisibility ? $validateData['competence6'] : null;
        $validateData['language_most_spoken'] = $this->workVisibility ? $validateData['language_most_spoken'] : null;
        $validateData['speak_percent'] = $this->workVisibility ? $validateData['speak_percent'] : null;
        $validateData['write_percent'] = $this->workVisibility ? $validateData['write_percent'] : null;
        $validateData['read_percent'] = $this->workVisibility ? $validateData['read_percent'] : null;
        $validateData['listen_percent'] = $this->workVisibility ? $validateData['listen_percent'] : null;
