(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_template_plugins_tempusdominus-bootstrap-4_js_tempusdominus-bootstrap-4_min_js"],{
...
!function () {
  ...
  var a,
    ...
    return i._int = function () {
      ...
      for (e in w[d] = "p", w) {
        w.hasOwnProperty(e) && "p" === w[e] && (o.push(e), parseInt(e, 10) !== d && (r[e] = !0));
      }
  ...
  E = jQuery, t = E.fn[M.NAME], p = ["top", "bottom", "auto"], C = ["left", "right", "auto"], T = ["default", "top", "bottom"], x = function (d) {
    ...
    return i._init = function () {
      ...
      for (e.eq(0).find("span").attr("title", this._options.tooltips.prevDecade), e.eq(1).attr("title", this._options.tooltips.selectDecade), e.eq(2).find("span").attr("title", this._options.tooltips.nextDecade), t.find(".disabled").removeClass("disabled"), this._options.minDate && this._options.minDate.isAfter(s, "y") && e.eq(0).addClass("disabled"), e.eq(1).text(s.year() + "-" + a.year()), this._options.maxDate && this._options.maxDate.isBefore(a, "y") && e.eq(2).addClass("disabled"), n += '<span data-action="selectYear" class="year old' + (this._isValid(s, "y") ? "" : " disabled") + '">' + (s.year() - 1) + "</span>"; !s.isAfter(a, "y");) {
