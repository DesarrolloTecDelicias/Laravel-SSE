...
$(document).on("click", "#helpGraduate", function (e) {
    Swal.fire({
        ...
        html: `<p class="text-justify">Hola egresado este es el asistente para apoyarte en este sistema.
                        ...
                        <p class="text-justify">Ya que sientas que hayas cumplido con estas opciones puedes subir tu currículum para
                        postularte, no puedes postularte si no tienes un currículum, lo podrás ver en la siguiente opción: <b>Currículum</b>.</p>
                        <p class="text-justify">Una vez finalizado con esto puedes ver los empleos disponibles en la siguente opción: <b>Ofertas de Trabajo</b>.</p>`,
        showCloseButton: true,
        showCancelButton: false,
        focusConfirm: false,
        confirmButtonText:
