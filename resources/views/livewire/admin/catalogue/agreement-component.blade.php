                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <x-input-component idInput='name' title="Nombre del convenio" lg="12" md="12"
                                sm="12" />
                            <x-input-component idInput='description' title="Descripción del convenio" lg="12"
                                md="12" sm="12" />
                            <div class="form-group">
                                <label for="type">Tipo de convenio</label>
                                <div class="controls">
                                    <select id="type" wire:model.defer="state.type"
                                        class="form-control @error('type') is-invalid @enderror"
                                        title="Mencione el tipo de convenio">
                                        <option value='' selected disabled="">Selecciona una opción</option>
