            ...
            <div class="d-flex flex-wrap">
                ...
                <table class="table table-bordered table-striped collapsed">
                    ...
                    <tbody>
                        <tr>
                            <td>&#123;&#123; $empresa &#125;&#125;</td>
                            <td class="text-center">Este tag permite regresar la razón social de la empresa</td>
                            <td class="text-center">Tecnológico de Delicias</td>
                        </tr>
                        <tr>
                            <td>&#123;&#123; $email &#125;&#125;</td>
                            <td class="text-center">Este tag permite regresar el correo de la empresa</td>
