<div>
    ...
    <hr>
    <div class="row">
        <x-input-component idInput='name' title="Nombre del Proyecto:" />
        <x-input-component idInput='description' title="Descripción de la problemática a resolver:" />
        <x-select-component idInput='period' title="Período Proyectado:" short="periodos" :options="$months" />
        <x-input-component idInput='benefits'
            title="Beneficios o algún tipo de apoyo (Beca económica, hospedaje, alimentación, otra)" />
    ...
    <x-save-component route='company.application.table' title="Editar Formato" />
